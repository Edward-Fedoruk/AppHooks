...
const RequestInfo = ({ classes, data }) => {
  ...
  const authType = data.endpoint === undefined || data.endpoint.auth_type === undefined
    ? null : data.endpoint.auth_type
  return (
    <Paper className={classes.root}>
      <Scrollbars>
        <div className={classes.wrap}>
          <Typography color="primary" className={classes.title}>Input Name:</Typography>
          <OutlinedInput value={data.endpoint === undefined ? "" : data.endpoint.name} fullWidth className={classes.input} />
        </div>

        <div className={classes.wrap}>
          <Typography color="primary" className={classes.title}>Incoming Gateway:</Typography>
          <OutlinedInput value={data.endpoint === undefined ? "" : data.endpoint.url} fullWidth className={classes.input} />
        </div>

        <div className={classes.wrap}>
          <Typography color="primary" className={classes.title}>Method:</Typography>
          <OutlinedInput value="Asynchronous" fullWidth className={classes.input} />
        </div>

        <div className={classes.wrap}>
          <Typography color="primary" className={classes.title}>Authentication:</Typography>
          <OutlinedInput
            value={authType === null
              ? "No Authentication" : authType}
            fullWidth
